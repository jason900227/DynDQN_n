...
DynDQN_n_E_n_step = 2
DynDQN_n_E_n_steps_cycle = 25
DynDQN_n_T_n_step = 2
DynDQN_n_T_n_steps_cycle = 1000
N_step = 3
...
# Plot the smoothed data
ax.plot(data['Epoch number'], data['Smoothed Episode reward'], label=f'DynDQN_n{DynDQN_n_T_n_step}_T{DynDQN_n_T_n_steps_cycle}', linestyle='-', color=colors[i+2], linewidth=2)
